...
Song will play with notes dropping to corresponding lane

F G H J are current key press options that user can use 

Notes will fall down from the top of the screen to the bottom 

Users must press the corresponding key to the notes 
